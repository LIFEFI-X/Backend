...
class User extends BaseController
{
    ...
    {
        $param = $this->getParam(['nickname', 'sex' => 2], ['nickname|Nickname' => 'max:20', 'sex|Gender' => 'in:0,1,2']);
    ...
    {
        $param = $this->getParam(['id', 'nickname', 'sex'], ['id' => 'require|number', 'nickname|Nickname' => 'max:10|chsDash', 'sex|Gender' => 'in:0,1,2']);
        if ($logic->edit($param))
            \Api::success();
        \Api::fail();
    }
